 ...
 * truly no way around. Bend-radius/deflection-angle validity of the result is
 * handled separately by `smoothSharpBends` (see bendSmoothing.ts) — this
 * function only cares about avoiding parcels.
 */
